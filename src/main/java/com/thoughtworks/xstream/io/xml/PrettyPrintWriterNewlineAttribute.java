 ...
 */
public class PrettyPrintWriterNewlineAttribute extends AbstractXmlWriter {
	...
	private PrettyPrintWriterNewlineAttribute(
	 ...
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(
	 ...
	 *             {@link PrettyPrintWriterNewlineAttribute#PrettyPrintWriterNewlineAttribute(Writer, int, char[], NameCoder)}
	 *             instead
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(
	 ...
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(Writer writer, char[] lineIndenter, String newLine) {
	 ...
	 * @since 1.3
	 */
	public PrettyPrintWriterNewlineAttribute(Writer writer, int mode, char[] lineIndenter) {
		this(writer, mode, lineIndenter, new XmlFriendlyNameCoder());
	}

	public PrettyPrintWriterNewlineAttribute(Writer writer, char[] lineIndenter) {
	 ...
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(Writer writer, String lineIndenter, String newLine) {
	 ...
	 * @since 1.3
	 */
	public PrettyPrintWriterNewlineAttribute(Writer writer, int mode, String lineIndenter) {
		this(writer, mode, lineIndenter.toCharArray());
	}

	public PrettyPrintWriterNewlineAttribute(Writer writer, String lineIndenter) {
	 ...
	 * @since 1.4
	 */
	public PrettyPrintWriterNewlineAttribute(Writer writer, int mode, NameCoder nameCoder) {
	 ...
	 * @since 1.3
	 * @deprecated As of 1.4 use
	 *             {@link PrettyPrintWriterNewlineAttribute#PrettyPrintWriterNewlineAttribute(Writer, int, NameCoder)}
	 *             instead
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(Writer writer, int mode, XmlFriendlyReplacer replacer) {
	 ...
	 * @since 1.4
	 */
	public PrettyPrintWriterNewlineAttribute(Writer writer, NameCoder nameCoder) {
		this(writer, XML_QUIRKS, new char[] { ' ', ' ' }, nameCoder, "\n");
	}

	/**
	 * @deprecated As of 1.4 use
	 *             {@link PrettyPrintWriterNewlineAttribute#PrettyPrintWriterNewlineAttribute(Writer, NameCoder)}
	 *             instead.
	 */
	@Deprecated
	public PrettyPrintWriterNewlineAttribute(Writer writer, XmlFriendlyReplacer replacer) {
	 ...
	 * @since 1.3
	 */
	public PrettyPrintWriterNewlineAttribute(Writer writer, int mode) {
		this(writer, mode, new char[] { ' ', ' ' });
	}

	public PrettyPrintWriterNewlineAttribute(Writer writer) {
		this(writer, new char[] { ' ', ' ' });
	}
